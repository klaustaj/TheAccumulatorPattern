...
def run_test_factorial():
    ...
    print('       actual (from my code): ', answer_from_my_code)
    print('       difference: ', answer_from_oracle - answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 4
    answer = count_cosines_from(0, 10, 0.5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 32
    answer = count_cosines_from(25, 75, -0.35)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 0
    answer = count_cosines_from(0, 1000, 1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 23
    answer = count_cosines_from(10, 32, -1)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.302252
    answer = sum_unit_fractions_from(26, 34)
